...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleValidation(
        ...
        ProblemDetail problem = ProblemDetail.forStatusAndDetail(HttpStatus.BAD_REQUEST, "請求參數驗證失敗");
    ...
    public ResponseEntity<ProblemDetail> handleNotAcceptable(
        ...
        problem.setInstance(URI.create(request.getRequestURI()));
        return problem(HttpStatus.NOT_ACCEPTABLE, problem);
    }
    ...
    public ResponseEntity<ProblemDetail> handleAiError(
        ...
        problem.setInstance(URI.create(request.getRequestURI()));
        return problem(HttpStatus.BAD_GATEWAY, problem);
    }
    ...
    public ResponseEntity<ProblemDetail> handleRuntime(
        ...
        problem.setInstance(URI.create(request.getRequestURI()));
        return problem(HttpStatus.INTERNAL_SERVER_ERROR, problem);
    }
    ...
    private ResponseEntity<ProblemDetail> problem(HttpStatus status, ProblemDetail problem) {
