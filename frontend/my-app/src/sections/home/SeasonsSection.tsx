...
const seasons: SeasonItem[] = [
  {
    ...
    cta: "查看春季路線",
    gradient:
      "from-lime-200 via-emerald-300 to-emerald-700",
    glow:
  ...
  },
  {
    ...
    cta: "查看夏季活動",
    gradient:
      "from-sky-200 via-cyan-300 to-blue-800",
    glow:
  ...
  },
  {
    ...
    cta: "查看秋季景點",
    gradient:
      "from-amber-200 via-yellow-300 to-orange-700",
    glow:
  ...
  },
  {
    ...
    cta: "查看冬季行程",
    gradient:
      "from-slate-200 via-slate-400 to-slate-900",
    glow:
...
const SeasonsSection = () => {
  ...
  return (
    <section className="relative overflow-clip bg-slate-950 text-white">
      <div className="absolute inset-0 bg-[linear-gradient(180deg,#08110d_0%,#07131b_100%)]" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 md:px-6 md:py-28">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="relative min-h-[420px] overflow-hidden rounded-[32px] border border-white/10 bg-slate-900">
            <AnimatePresence mode="wait">
              <motion.div
