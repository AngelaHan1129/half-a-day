...
const HeroSection = () => {
    ...
    return (
        <section className="relative min-h-[200vh] overflow-clip bg-gradient-to-b from-slate-950 via-emerald-950 to-lime-50 text-white">
            <DoorReveal />
                ...
                <div className="grid w-full max-w-6xl gap-8 text-center">
                    ...
                    >
                        <img
                            src={logo}
                            alt="小半天休閒農業區 Logo"
                            className="mx-auto w-[320px] brightness-0 invert drop-shadow-[0_18px_48px_rgba(0,0,0,0.28)] md:w-[520px] xl:w-[680px]"
                        />
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="mt-2 grid place-items-center gap-2 text-xs uppercase tracking-[0.24em] text-white/55"
                    >
